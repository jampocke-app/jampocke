  ...
  <div class="header">
    ...
    <div class="header2">
      <nav class="gnav">
        ...
        <div class="tohoku">
          <select name="tohoku">
            <option selected disabled>東北</option>
        ...
        <div class="sikoku">
          <select name="tyugoku">
            <option selected disabled>四国</option>
        ...
        <div class="kyusyu">
          <select name="tyugoku">
            <option selected disabled>九州</option>
